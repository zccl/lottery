var ball = document.getElementsByTagName("li"),
	selected_li = document.getElementsByClassName("selected")[0].getElementsByTagName("li"),
	checked_li = document.getElementsByClassName("checked")[0].getElementsByTagName("li"),
	...
	function rand() {
		for(var i = 0;; i++) {
			var ar = new Array();
			for(var j = 0; j < 7; j++) {
				ar.push(Math.ceil(Math.random() * 33));
			}
			var flag = false;
			for(var k = 0; k < 7; k++) {
				for(var n = 6; n > k; n--) {
